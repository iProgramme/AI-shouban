const fkdwc2Texts = {
  // 页面标题和描述
  pageTitle: '疯狂动物城2合照 - 专业的AI合照生成服务',
  pageDescription: '使用AI技术将您的照片转换为精美的疯狂动物城2风格合照，简单快捷，效果惊艳',
  ...
  // 首页头部区域
  heroTitle1: '将您的照片',
  heroTitle2: '转换为疯狂动物城2风格合照',
  heroDescription: '使用先进的AI技术，只需上传一张照片，即可生成专业级疯狂动物城2风格合照。\n简单、快速、效果惊艳',
  ...
  feature2Title: '专业品质',
  feature2Desc: '高质量的疯狂动物城2风格转换，细节丰富，效果惊艳',
  feature3Title: '安全可靠',
  feature3Desc: '您的隐私和数据安全是我们的首要考虑',
  feature4Title: '价格实惠',
  feature4Desc: '合理的价格，让每个人都能享受AI疯狂动物城2合照生成服务',
  ...
  step3: '获得疯狂动物城2合照',
  step3Desc: 'AI自动处理，生成精美的疯狂动物城2风格合照',
  ...
  // 生成部分
  generateSectionTitle: '开始生成您的疯狂动物城2合照',
  generateSectionDescription: '上传图片并输入兑换码，即可生成专属疯狂动物城2风格合照',
  ...
  resultSectionTitle: '疯狂动物城2合照生成结果',
  ...
  successImageGenerated: '疯狂动物城2合照生成成功！耗时 ',
  ...
  successImageGeneration: '疯狂动物城2合照生成成功',
  ...
  faq2Answer: '通常在提交图片后，AI会在数秒内完成疯狂动物城2合照生成。处理时间也取决于当前服务器负载情况。',
  ...
  // 页脚
  footerDescription: '专业的AI疯狂动物城2合照生成服务，让您的照片焕发新的生命力',
  footerQuickLinks: '快速链接',
  footerLegalInfo: '法律信息',
  footerContact: '联系方式',
  footerCopyRight: '© 2024 疯狂动物城2合照. 保留所有权利.',

  // 联系页面
  contactPageTitle: '联系我们 - 疯狂动物城2合照',
  ...
  // 隐私政策和条款页面
  privacyPageTitle: '隐私政策 - 疯狂动物城2合照',
  privacyPageDescription: '隐私政策',
  privacyTitle: '隐私政策',
  privacySection1Title: '1. 信息收集',
  privacySection1Content: '我们收集您上传的图片、兑换码使用记录以及必要的联系信息，用于提供AI疯狂动物城2合照生成服务。具体包括：',
  privacySection1List: [
    '账户信息：当您注册账户时，我们会收集您的邮箱地址等基本信息',
    '上传内容：您上传的图片将用于AI处理，生成相应的疯狂动物城2风格合照',
  ...
  termsPageTitle: '服务条款 - 疯狂动物城2合照',
  termsPageDescription: '服务条款',
  termsTitle: '服务条款',
  termsSection1Title: '1. 服务说明',
  termsSection1Content: '本服务提供AI疯狂动物城2合照生成功能，用户上传图片后，系统将生成对应的个性化疯狂动物城2风格合照。我们努力提供准确、高质量的服务，但生成结果可能存在差异。',
  ...
  // 作品展示图片
  galleryImage1Input: '/images/fkdwc2-input1.png',
  galleryImage1Output: '/images/fkdwc2-output1.png',
  galleryImage2Input: '/images/fkdwc2-input2.png',
  galleryImage2Output: '/images/fkdwc2-output2.png',
  galleryImage3Input: '/images/fkdwc2-input3.png',
  galleryImage3Output: '/images/fkdwc2-output3.png',
  galleryImage4Input: '/images/fkdwc2-input4.png',
  galleryImage4Output: '/images/fkdwc2-output4.png',
  heroImage: '/images/fkdwc2-hero.png',

  // 生成提示词
  imageGenerationPrompt: '在电影院内自拍视角，图中人物位于画面中央，两侧是《疯狂动物城》的朱迪兔（左侧，穿蓝色警服，表情开心）和尼克狐（右侧，穿黄绿色衬衫 + 领带，慵懒表情）；背景是电影院的座椅、观众，前方大屏幕正在播放《疯狂动物城》动画电影的画面（屏幕上显示载满动物的绿色双层巴士，城市背景）；整体风格是真实照片质感，光线是电影院的昏暗环境光 + 屏幕的亮光，画面清晰自然，角色融合真实不违和',
  // 生成模板
  imageGenerationTemplate: '疯狂动物城2风格合照-一键填入',
  // 其他
  logoText: '疯狂动物城2合照'
};
export default fkdwc2Texts;