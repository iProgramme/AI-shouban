const fkdwc2Texts = {
  ...
  // 生成提示词
  imageGenerationPrompt: '在电影院内自拍视角，图中人物位于画面中央，两侧是《疯狂动物城》的朱迪兔（左侧，穿蓝色警服，表情开心）和尼克狐（右侧，穿黄绿色衬衫 + 领带，慵懒表情）；背景是电影院的座椅、观众，前方大屏幕正在播放《疯狂动物城》动画电影的画面；整体风格是真实照片质感，光线是电影院的昏暗环境光 + 屏幕的亮光，画面清晰自然，角色融合真实不违和',
  // 生成模板
