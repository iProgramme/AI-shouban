...
// AI水墨画风格文本配置
const inkPaintingTexts = {
  pageTitle: 'AI水墨画生成 - 专业的水墨画风格图像转换服务',
  pageDescription: '使用AI技术将您的照片转换为古典水墨画风格，展现东方美学韵味',
  ...
  heroTitle1: '将您的照片',
  heroTitle2: '转换为古典水墨画',
  heroDescription: '使用先进的AI技术，将您的照片转换为古典水墨画风格，展现东方艺术韵味。\\n典雅、意境、韵味悠长',
  heroCtaPrimary: '立即开始转换',
  heroCtaSecondary: '查看作品展示',

  featuresTitle: '为什么选择我们',
  featuresDescription: '专业的技术，独特的东方美学',
  feature1Title: '快速转换',
  feature1Desc: '先进的AI算法，数秒内完成水墨画风格转换',
  feature2Title: '古典韵味',
  feature2Desc: '专业水墨画风格，还原传统艺术韵味',
  feature3Title: '安全可靠',
  feature3Desc: '您的隐私和数据安全是我们的首要考虑',
  feature4Title: '价格实惠',
  feature4Desc: '合理的价格，让每个人都能体验水墨艺术魅力',
  ...
  step2Desc: '使用兑换码解锁生成功能，或购买新的兑换码',
  step3: '获得水墨画',
  step3Desc: 'AI自动处理，生成古典水墨画风格图像',

  galleryPreviewTitle: '作品展示',
  galleryPreviewDescription: '看看其他用户生成的水墨画作品',
  galleryOriginal: '原图',
  galleryGenerated: '水墨画效果',
  galleryCtaDescription: '更多作品将在后续版本中展示',

  generateSectionTitle: '开始生成您的水墨画',
  generateSectionDescription: '上传图片并输入兑换码，即可生成专属水墨画',
  uploadSectionTitle: '上传图片',
  hintUpload: '支持 JPG、PNG 格式，最大 5MB',
  selectImage: '选择图片',
  clickBelowUpload: '点击下方按钮上传图片',
  ...
  faq1Answer: '您可以在首页点击购买兑换码，选择合适的套餐进行购买。我们提供多种套餐以满足不同需求。',
  faq2Question: '生成时间需要多久？',
  faq2Answer: '通常在提交图片后，AI会在数秒内完成水墨画生成。处理时间也取决于当前服务器负载情况。',
  faq3Question: '支持哪些图片格式？',
  faq3Answer: '目前支持JPG、PNG格式的图片，大小不超过5MB。建议使用人物或风景照片以获得最佳效果。',
  faq4Question: '批量购买有什么优惠？',
  faq4Answer: '20张以上可联系我们获取批量优惠价格。我们为商业用户和大量需求用户提供定制化方案。',

  footerDescription: '专业的AI水墨画生成服务，让您的照片展现东方艺术韵味',
  footerQuickLinks: '快速链接',
  footerLegalInfo: '法律信息',
  footerContact: '联系方式',
  footerCopyRight: '© 2024 AI水墨画生成. 保留所有权利.',

  contactPageTitle: '联系我们 - AI水墨画生成',
  contactPageDescription: '联系我们获取支持',
  contactTitle: '联系我们',
  contactSubtitle: '有任何问题？我们随时为您提供帮助',
  contactWechat: '微信咨询',
  ...
  privacyPageTitle: '隐私政策 - AI水墨画生成',
  privacyPageDescription: '隐私政策',
  privacyTitle: '隐私政策',
  privacySection1Title: '1. 信息收集',
  privacySection1Content: '我们收集您上传的图片、兑换码使用记录以及必要的联系信息，用于提供AI水墨画生成服务。',
  privacySection2Title: '2. 信息使用',
  privacySection2Content: '我们使用收集的信息来：',
  ...
  privacyTitle: '隐私政策',
  privacySection1Title: '1. 信息收集',
  privacySection1Content: '我们收集您上传的图片、兑换码使用记录以及必要的联系信息，用于提供AI水墨画生成服务。具体包括：',
  privacySection1List: [
    '账户信息：当您注册账户时，我们会收集您的邮箱地址等基本信息',
    '上传内容：您上传的图片将用于AI处理，生成相应的水墨画风格图像',
    '设备信息：我们可能会收集您的设备型号、操作系统版本、浏览器类型等信息',
    '使用数据：包括您使用服务的时间、频率、兑换码使用情况等',
    '日志信息：包括IP地址、访问时间、浏览器类型等'
  ],
  ...
  termsPageTitle: '服务条款 - AI水墨画生成',
  termsPageDescription: '服务条款',
  termsTitle: '服务条款',
  termsSection1Title: '1. 服务说明',
  termsSection1Content: '本服务提供AI水墨画图像生成功能，用户上传图片后，系统将生成对应的个性化水墨画风格图像。我们努力提供准确、高质量的服务，但生成结果可能存在差异。',
  termsSection2Title: '2. 用户责任',
  termsSection2Content: '用户在使用本服务时，应确保：',
  termsSection2List: [
    '上传的图片不侵犯他人版权、商标、专利或其他知识产权',
  ...
  // 作品展示图片
  galleryImage1Input: '/images/ink-input.png',
  galleryImage1Output: '/images/ink-output.png',
  galleryImage2Input: '/images/ink-input.png',
  galleryImage2Output: '/images/ink-output.png',
  galleryImage3Input: '/images/ink-input.png',
  galleryImage3Output: '/images/ink-output.png',
  galleryImage4Input: '/images/ink-input.png',
  galleryImage4Output: '/images/ink-output.png',
  heroImage: '/images/ink-hero.png',

  // 生成提示词
  imageGenerationPrompt: '请将这张人物照片转换为古典水墨画风格。请保持原始画面的意境，但以水墨画技法和风格呈现。',
...
// AI 3D图像生成文本配置
const threeDTexts = {
  pageTitle: 'AI 3D图像生成 - 专业的3D立体图像生成服务',
  pageDescription: '使用AI技术将您的照片转换为立体3D图像，打造沉浸式视觉体验',
  ...
  heroTitle1: '将您的照片',
  heroTitle2: '转换为3D立体图像',
  heroDescription: '使用先进的AI技术，将您的照片转换为专业的3D立体图像，带来沉浸式视觉体验。\\n立体、生动、栩栩如生',
  heroCtaPrimary: '立即开始生成',
  heroCtaSecondary: '查看作品展示',

  featuresTitle: '为什么选择我们',
  featuresDescription: '专业的技术，沉浸式的3D体验',
  feature1Title: '快速生成',
  feature1Desc: '先进的AI算法，数秒内完成3D图像生成',
  feature2Title: '立体效果',
  feature2Desc: '专业的3D渲染技术，打造立体视觉效果',
  feature3Title: '安全可靠',
  feature3Desc: '您的隐私和数据安全是我们的首要考虑',
  feature4Title: '价格实惠',
  feature4Desc: '合理的价格，让每个人都能体验3D技术魅力',
  ...
  step2Desc: '使用兑换码解锁生成功能，或购买新的兑换码',
  step3: '获得3D图像',
  step3Desc: 'AI自动处理，生成立体3D风格图像',

  galleryPreviewTitle: '作品展示',
  galleryPreviewDescription: '看看其他用户生成的3D图像作品',
  galleryOriginal: '原图',
  galleryGenerated: '3D效果',
  galleryCtaDescription: '更多作品将在后续版本中展示',

  generateSectionTitle: '开始生成您的3D图像',
  generateSectionDescription: '上传图片并输入兑换码，即可生成专属3D图像',
  uploadSectionTitle: '上传图片',
  hintUpload: '支持 JPG、PNG 格式，最大 5MB',
  selectImage: '选择图片',
  clickBelowUpload: '点击下方按钮上传图片',
  ...
  faq1Answer: '您可以在首页点击购买兑换码，选择合适的套餐进行购买。我们提供多种套餐以满足不同需求。',
  faq2Question: '生成时间需要多久？',
  faq2Answer: '通常在提交图片后，AI会在数秒内完成3D图像生成。处理时间也取决于当前服务器负载情况。',
  faq3Question: '支持哪些图片格式？',
  faq3Answer: '目前支持JPG、PNG格式的图片，大小不超过5MB。建议使用人物或物体照片以获得最佳效果。',
  faq4Question: '批量购买有什么优惠？',
  faq4Answer: '20张以上可联系我们获取批量优惠价格。我们为商业用户和大量需求用户提供定制化方案。',

  footerDescription: '专业的AI 3D图像生成服务，让您的照片拥有立体生命力',
  footerQuickLinks: '快速链接',
  footerLegalInfo: '法律信息',
  footerContact: '联系方式',
  footerCopyRight: '© 2024 AI 3D图像生成. 保留所有权利.',

  contactPageTitle: '联系我们 - AI 3D图像生成',
  contactPageDescription: '联系我们获取支持',
  contactTitle: '联系我们',
  contactSubtitle: '有任何问题？我们随时为您提供帮助',
  contactWechat: '微信咨询',
  ...
  privacyPageTitle: '隐私政策 - AI 3D图像生成',
  privacyPageDescription: '隐私政策',
  privacyTitle: '隐私政策',
  privacySection1Title: '1. 信息收集',
  privacySection1Content: '我们收集您上传的图片、兑换码使用记录以及必要的联系信息，用于提供AI 3D图像生成服务。具体包括：',
  privacySection1List: [
    '账户信息：当您注册账户时，我们会收集您的邮箱地址等基本信息',
    '上传内容：您上传的图片将用于AI处理，生成相应的3D立体图像',
    '设备信息：我们可能会收集您的设备型号、操作系统版本、浏览器类型等信息',
    '使用数据：包括您使用服务的时间、频率、兑换码使用情况等',
    '日志信息：包括IP地址、访问时间、浏览器类型等'
  ],
  ...
  termsPageTitle: '服务条款 - AI 3D图像生成',
  termsPageDescription: '服务条款',
  termsTitle: '服务条款',
  termsSection1Title: '1. 服务说明',
  termsSection1Content: '本服务提供AI 3D图像生成功能，用户上传图片后，系统将生成对应的个性化3D立体图像。我们努力提供准确、高质量的服务，但生成结果可能存在差异。',
  termsSection2Title: '2. 用户责任',
  termsSection2Content: '用户在使用本服务时，应确保：',
  termsSection2List: [
    '上传的图片不侵犯他人版权、商标、专利或其他知识产权',
  ...
  // 作品展示图片
  galleryImage1Input: '/images/3d-input.png',
  galleryImage1Output: '/images/3d-output.png',
  galleryImage2Input: '/images/3d-input.png',
  galleryImage2Output: '/images/3d-output.png',
  galleryImage3Input: '/images/3d-input.png',
  galleryImage3Output: '/images/3d-output.png',
  galleryImage4Input: '/images/3d-input.png',
  galleryImage4Output: '/images/3d-output.png',
  heroImage: '/images/3d-hero.png',

  // 生成提示词
  imageGenerationPrompt: '请将这张人物照片转换为立体3D图像风格。请保持原始人物的特征，但以3D立体渲染风格呈现，突出深度和立体感。',
...
export function getLocalizedTexts() {
  const appType = process.env.APP_TYPE || 'default'; // 默认为手办生成

  switch(appType) {
    case 'ink':
      return inkPaintingTexts;
    case '3d':
      return threeDTexts;
    case 'default':
    default:
